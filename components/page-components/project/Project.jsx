...
const Project = () => {
  ...
  return (
    <div className="Project-sect overflow-hidden mx-auto Our-pillar-sec  w-full 2xl:h-full flex  flex-col justify-center items-center 2xl:px-20 px-5  md:py-[100px] py-[20px] bg-gradient-to-b from-gray-950 to-gray-800 ">
      <div
          data-aos="fade-left"
          className="relative top w-full flex flex-col justify-start items-start"
        >
            <div className="content  flex flex-col  justify-start items-start">
            <p className="w-full text-left flex 2xl:justify-start 2xl:items-start justify-start 2xl:text-[56px] md:text-[58px] text-[36px] text-secondary font-bold 2xl:mt-10 mt-10">
