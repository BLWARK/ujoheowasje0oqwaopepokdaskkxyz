...
const AboutUs = () => {
  ...
  return (
    ...
    <Image
      ...
      <div data-aos="fade-right" className="left w-full 2xl:w-1/2 xl:w-1/2 lg:w-full md:w-full flex 2xl:flex-col flex-row  justify-center items-center 2xl:mt-[590px] mt-10 ">
      <Image
        src="/AboutUs.png"
        alt="Hero Image"
        width={650}
     ...
     >
      ...
      <div data-aos="fade-left" className="relative right w-full 2xl:w-1/2 xl:w-full lg:w-full md:w-full flex justify-end items-end 2xl:-mt-20">
      <div className="content  flex flex-col  md:justify-center md:items-center 2xl:justify-start 2xl:items-start">
      <div
     ...
     >
      ...
      <p className=" 2xl:text-[28px] text-[20px] text-secondary font-bold w-[80%] 2xl:mt-10 mt-20">
            About Us
          </p>
      <div className="w-[100px] h-[5px] bg-hover rounded-full my-5"></div>
          ...
          <p className="text-white font-medium w-[80%] mt-5">
