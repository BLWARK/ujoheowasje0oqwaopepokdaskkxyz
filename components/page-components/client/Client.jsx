  ...
  return (
    ...
    <div data-aos="fade-left" className="relative top w-full flex justify-center items-center">
      <div className="content flex flex-col md:justify-center md:items-center 2xl:justify-center 2xl:items-center justify-start items-start">
        ...
        {/* Client Grid */}
        <div className="grid grid-cols-3 md:grid-cols-6 gap-6 mt-10 2xl:mb-0 mb-10 ">
          {clientImages.map((imageSrc, index) => (
            <div key={index} className="p-6 bg-white rounded-lg shadow-lg flex items-center justify-center 2xl:w-[200px] 2xl:h-[100px] w-[100px] h-[50px] backdrop-blur-2xl bg-white/40 ">
              <Image
                src={imageSrc}
                alt={`Client ${index + 1}`}
                width={200}
