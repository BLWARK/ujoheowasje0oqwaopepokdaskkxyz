        ...
        >
          <div className="content  flex flex-col  md:justify-center md:items-center 2xl:justify-center 2xl:items-center justify-start items-start">
            ...
            <p className="text-white font-medium w-[80%] mt-5 2xl:text-center text-left">
              we believe in a seamless synergy that drives innovation and
              growth. Our company stands on three core pillars designed to
              provide comprehensive and dynamic solutions to our clients.
            </p>
            
            <div className="grid gap-10 py-10 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-items-center mt-10 px-5 ">
              {/* Card 1 */}
              <div data-aos="flip-right"  className="relative bg-gradient-to-tr from-purple-950 to-purple-400 rounded-3xl shadow-lg overflow-hidden 2xl:w-[400px] w-[350px] h-[500px] transform transition duration-300 hover:scale-105 hover:shadow-purple-300/80">
              ...
              {/* Card 2 */}
              <div data-aos="flip-left" className="relative bg-gradient-to-tr from-purple-950 to-purple-400 rounded-3xl shadow-lg overflow-hidden 2xl:w-[400px] w-[350px] h-[500px] transform transition duration-300 hover:scale-105 hover:shadow-purple-300/80">
                <img
                  src="/Legal.webp"
                  alt="Anxiety"
                  className="w-full h-[300px] object-cover"
                ...
                <div className="p-5">
                  ...
                  <p className="text-white mb-4 text-[12px] font-light">
                    ...
                    services to safeguard intellectual property, strengthen
                    legal frameworks, and build vibrant communities that connect
                    brands and their audiences effectively.
                  </p>
                </div>
                {/* Overlay and Button */}
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300">
              ...
              <div data-aos="flip-right" className="relative bg-gradient-to-tr from-purple-950 to-purple-400 rounded-3xl shadow-lg overflow-hidden 2xl:w-[400px] w-[350px] h-[500px] transform transition duration-300 hover:scale-105 hover:shadow-purple-300/80">
                ...
                <div className="p-5">
                  ...
                  <p className="text-white mb-4 text-[12px] font-light">
                    ...
                    leveraging cutting-edge strategies to maximize visibility
