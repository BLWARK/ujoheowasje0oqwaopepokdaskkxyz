...
const Teams = () => {
  ...
  return (
    ...
    id="Teams"
    data-aos="fade-up"
    className="Leaders Our-pillar-sec w-full 2xl:h-full flex flex-col 2xl:justify-center 2xl:items-center justify-start items-start 2xl:px-20 px-5 md:py-[100px] py-[20px] bg-gray-700"
  >
    ...
    <p className="w-full flex 2xl:justify-center 2xl:items-center md:justify-center md:items-center justify-start items-start text-secondary 2xl:text-[56px] md:text-[58px] text-[36px] font-bold">
      Driven by Leadership, Inspired by Creativity
    </p>

    <p className="text-white font-medium 2xl:w-[80%] w-[95%] mt-5 2xl:text-center text-left">
    ...
    <div data-aos="fade-up" className="content flex flex-col 2xl:flex-row xl:flex-row lg:flex-row md:flex-col items-center gap-8 w-full rounded-lg 2xl:p-10 px-2 py-10 relative">
      <button
        onClick={handlePrev}
        className="absolute left-0 top-1/2 transform -translate-y-1/2 p-3 2xl:block hidden bg-secondary text-white rounded-full hover:bg-hover transition"
      >
        <FaArrowLeft size={24} />
      </button>
      ...
      >
        <h2 className="text-2xl font-bold 2xl:text-[56px] md:text-[58px] text-[36px]">
          {selectedLeader.name}
        </h2>
        <h3 className="text-lg font-light 2xl:text-[28px] md:text-[58px] text-[36px] text-secondary">
      ...
      <button
        onClick={handleNext}
        className="absolute right-0 top-1/2 transform -translate-y-1/2 p-3 2xl:block hidden bg-secondary text-white rounded-full shadow-lg hover:bg-hover transition"
      >
